...
//echo '<div id="fb" xstyle="float:right; width: 292px; margin-left:20px;">';
//echo '<fb:comments numposts="5" width="292"></fb:comments>';
//echo '<img id="statusbild" src="images/status.jpg" alt="aktuell status" title="aktuell status" style="width:292px;"/>';
...
<iframe 
	...
	src="<?php echo htmlspecialchars($RoboCam_adr); ?>"
>
</iframe>
...
<?php if(false): ?>
	...
	<div style="position:absolute; top: 0; left: 0;border: outset 1px; background: #ffff77;padding:7px;text-align:left;">
		Välkommen! Din ip-adress är (<?php echo $_SERVER["REMOTE_ADDR"]; ?>) 
	</div>
